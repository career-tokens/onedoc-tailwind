...
const page = () => {
  return (
      <div className="cv  font-[Merriweather] font-[500] min-h-screen w-screen px-6 py-4 text-left">
          ...
          <div className="details flex flex-col mb-2">
          ...
          <div className="education flex flex-col mb-2">
...
unstructured data for OTC trading. www.lleedpartners.com</span>
              ...
              <div className="work-exp2 flex flex-col mb-2">
              <div className="flex justify-between">
                  <span className="font-[600]">Louis Dreyfus Company, Commodities Merchant and Trading </span>
                  <span>Singapore, Singapore and Geneva GE, Switzerland</span>
              </div>
              <div className="flex justify-between">
...
field of FFA trading led to starting my company in which LDC and Rio Tinto are clients</span>
              ...
              <div className="work-exp3 flex flex-col mb-2">
              <div className="flex justify-between">
...
thousands of wireless sensors in C# using the .Net Framework.</span>
              ...
              <div className="work-exp4 flex flex-col mb-2">
              <div className="flex justify-between">
...
Node JS.</span>
              ...
              <div className="work-exp5 flex flex-col mb-2">
              <div className="flex justify-between">
...
analysis and machine learning models such as SVMs, auto encoders and convolutional encoders.</span>
          ...
          <div className="coursework flex flex-col mb-2">
              <span className="text-xl text-center p-1 border-b-2 border-black mb-2">COURSEWORK/SKILLS</span>
                      <span><span className="font-bold">• Mathematics:</span>Calculus, Linear Algebra, Information Theory, Signal Processing, Discrete Mathematics, Set Theory, Algebra, Algo-
rithms, Statistics, Probability Theory, Stochastic Processes, Computational Statistics, Computational Intelligence Lab</span>
                      <span><span className="font-bold">• Computer Science:</span>Advanced Machine Learning, Probabilistic Artificial Intelligence, Parallelism and Concurrency, OO Program-
...
Computing, Digital Signatures</span>
                      <span><span className="font-bold">• Programming:</span>C, R, Python (Django and data science libraries), Java, SQL, Scala (and Spark), C# (.NET), Javascript (React Js,
Node Js), SQL, Assembly, LaTex</span>
          ...
          <div className="additional-info flex flex-col">
              <span className="text-xl text-center p-1 border-b-2 border-black mb-2">ADDITIONAL INFO</span>
                      <span><span className="font-bold">• Personal Interests:</span>Blockchain, Politics, Music, Study of Latin and Ancient Greek.</span>
                      <span><span className="font-bold">• Activites:</span>Classical Guitar and Solfeggio in regional conservatory with DEM and CEM state certificates (9 years of practice and
ability to teach), Tennis, Soccer, Hiking, Chess</span>
                      <span><span className="font-bold">• Languages (speaking and writing):</span>French (Native), English (Native), Spanish (B1)</span>
          </div>
    </div>
  )
}
